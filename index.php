...
<body>
  ...
  <main id="main"></main>
    <div class="hero-container">
      ...
      <div id="MenuMap" class="boxTool" style="bottom: 10px;">
        ...
        <button type="button" id="cmdLayers" class="btn btn-outline-success" title="Layers">
      ...
      <div class="boxTool card col-5" id="BoxLayers">
        <div class="card-header" id="BoxLayersheader">
          Daftar Layers
        </div>
        <div class="card-body row" id="Layers">
  ...
  // fungsi tombol
  document.getElementById("cmdBasemap").addEventListener("click", function(){
  ...
  document.getElementById("cmdLayers").addEventListener("click", function(){
  ...
  function LoadTreLayerList() {	
    ...
    if(layer.get('name')){
      var legend = layer.get('LegenUrl');
        ...
        layerTreeList = ListLegenTree + layerTreeList;
        n++;
      }
    });

    $('#LayerTreeList').html(layerTreeList)
  };
  ...
  function bindInputs(layerid, layer) {
    ...
    var LegendInput = $(layerid + '_NM');
    var LegendDIV = $(layerid + '_FS');
    LegendDIV.hide();
    LegendInput.on('click', function () {
    LegendDIV.show();
    });
    LegendInput.on('dblclick', function () {
      LegendDIV.hide();
    });
